const CONFIG = {
    mainQuestion: "Open here",
    subQuestion: "For my love",
    yesButton: "YES",
    noButton: "NO",
    noEscapeTexts: ["nononono ya😝", "Gabisa Jawa😜", "Aku anggep YES yahahayuq 💕"],
    confirmTitle: "HAPPY BIRTHDAY MY LOVE 💗",
    confirmText: "Enjoy your last teen",
    badgeText: "Yuda Mahendra",
    nextButton: "Next ",
    repeatButton: "Repeat",
    flowerTitle: "This sweet cake is for a beautiful soul like you ⋆｡‧˚ʚɞ˚‧｡⋆",
    takeBouquetButton: "Take the cake ",
    bouquetMessage: "Yeay! Now its Yours 💕",
    nextFlowerButton: "Next ",
    collageTitle: "HAPPY BIRTHDAY",
    collageSubtitle: "Sayangku, semoga diumur yang ke-19 kamu menjadi pribadi yang lebih baik, dan nikmati masa-masa last teen ini. Selalu bahagia dan selalu dilindungi",
